    ...
    <section className="relative py-[50px] bg-gradient-to-tr from-primary from-50% to-[#163c1e] to-50% text-white overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 flex flex-col items-center">
        ...
        <p className="text-base md:text-lg text-primary-light max-w-xl mb-8 opacity-90">
          Connect with experienced CAs, CSs, and legal experts for complete compliance support.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
          ...
          <Button
            ...
            href="tel:7600049383"
            icon={Phone}
            className="w-full sm:w-auto !text-white !border-white hover:!bg-white/10 vibrate-on-hover"
          />
        </div>
      </div>
    </section>
