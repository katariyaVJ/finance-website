...
export default function Footer() {
  ...
  return (
    <footer className="bg-white text-white relative overflow-hidden z-10 pt-8 pb-12 px-4 md:px-8 leading-[21px]">
      ...
      <div className="max-w-7xl mx-auto bg-gradient-to-b from-[#1a4425] to-[#102b17] border border-white/10 rounded-[2.5rem] p-8 md:p-14 shadow-2xl relative overflow-hidden">
        ...
        <div className="pb-8 md:pb-12 mb-10 md:mb-12 flex flex-col gap-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 pb-12 relative z-10">
          ...
          <div className="lg:col-span-4 flex flex-col space-y-6 text-left">
            ...
            <p className="text-sm font-sans font-semibold text-primary-light/80 leading-relaxed max-w-sm">
          ...
          <div className="lg:col-span-3 flex flex-col space-y-4 text-left">
            ...
            <div className="flex flex-col space-y-4 text-sm text-primary-light/80">
              ...
              >
                ...
                <span className="font-semibold">+91 76000 49383</span>
              </a>
              ...
              >
                ...
                <span className="font-semibold">hkfinance0807@gmail.com</span>
              </a>
        ...
        <div className="pt-8 text-center text-sm font-bold text-primary-light/70 relative z-10" style={{ fontFamily: "'Montserrat', sans-serif" }}>
